...
<div class="navbar-default navbar-collapse" id="slider_sub">
    <ul class="nav">
        <li>
            <a href="${pageContext.request.contextPath}/jump/Jump2user_index" class="sub">系统首页<span
                    class="glyphicon glyphicon-home pull-right"></span></a>

        </li>
        <li>
            <a href="#sub1" data-toggle="collapse" class="sub">生涯规划<span
                    class="glyphicon glyphicon-chevron-right pull-right"></span></a>
            <ul id="sub1" class="nav collapse">
                <li><a href="${pageContext.request.contextPath}/jump/Jump2user_evaluate"><span
                        class="glyphicon glyphicon-globe"></span>&nbsp;自我评估</a></li>
                <li><a href="${pageContext.request.contextPath}/evaluate/evaluate_answer"><span
                        class="glyphicon glyphicon-globe"></span>&nbsp;查看评估结果</a></li>
        ...
        <li>
            <a href="#sub2" data-toggle="collapse" class="sub">学习提升<span
                    class="glyphicon glyphicon-chevron-right pull-right"></span></a>
            <ul id="sub2" class="nav collapse">
                <li><a href="${pageContext.request.contextPath}/jump/user_data_download"><span class="glyphicon glyphicon-download-alt"></span>&nbsp;学习资料下载</a></li>
                <li><a href="${pageContext.request.contextPath}/jump/user_class"><span class="glyphicon glyphicon-transfer"></span>&nbsp;参加辅导课程</a></li>
            </ul>

        </li>
        <li>
            <a href="#sub3" data-toggle="collapse" class="sub">考生论坛<span
                    class="glyphicon glyphicon-chevron-right pull-right"></span></a>
            <ul id="sub3" class="nav collapse">
                <li><a href="${pageContext.request.contextPath}/questions/user_questionList"><span
                        class="glyphicon glyphicon-signal"></span>&nbsp;进入考生论坛</a></li>
        ...
        <li>
            <a href="#sub4" data-toggle="collapse" class="sub">院校查询<span
                    class="glyphicon glyphicon-chevron-right pull-right"></span></a>
        ...
        <li>
            <a href="#sub5" data-toggle="collapse" class="sub">用户中心<span
                    class="glyphicon glyphicon-chevron-right pull-right"></span></a>
