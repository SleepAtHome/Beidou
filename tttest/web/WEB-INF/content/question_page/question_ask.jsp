    ...
    <div class="panel-body">
        <div class="container">
            ...
            <div>
                ...
                <form class="form-horizontal" action="${pageContext.request.contextPath}/questions/question_add"
                      method="post">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control " required="required" placeholder="请输入问题简述"
                                   name="questionTitle">
                        </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control " required="required" placeholder="请输入问题分值"
                                   name="questionInter">
                        </div>
                        <span class="help-block" class="col-sm-4"
                              style="font-size:14px;line-height:34px;vertical-align:baseline;"></span>
                    ...
                    <div class="form-group ">
                        ...
                        <span class="help-block" class="col-sm-2"
                              style="font-size:14px;line-height:34px;vertical-align:baseline;"></span>
                    </div>
                    <div class="form-group form-inline">
                        ...
                        <a type="button" class="btn btn-link"
                           href="${pageContext.request.contextPath}/questions/user_questionList">取消</a>
