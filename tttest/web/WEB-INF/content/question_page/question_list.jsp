                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                        <ul class="nav navbar-nav">
                            <li>
                                <a href="${pageContext.request.contextPath}/jump/Jump2question_ask"><span
                        ...
                        <form class="navbar-form navbar-left"
                            ...
                            <div class="form-group">
                                <input type="text" name="conditionSearch" class="form-control" placeholder="输入要检索的问题">
                            </div>
                            <button type="submit" class="btn  btn-info">搜索问题</button>
                            <button type="button" class="btn  btn-info">查看我提的问题</button>
                        </form>
