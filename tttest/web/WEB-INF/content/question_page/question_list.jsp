...
<html>
	...
	<div class="panel panel-info">
				...
				<nav class="navbar navbar-default">
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
							...
							<form class="navbar-form navbar-left" action="${pageContext.request.contextPath}/questions/condition_search" method="post" role="search">
  	...
  	<span class="badge" style="background-color: #5bc0de; border-radius: 6x;"><%=q.getAccount()%>回答</span>
