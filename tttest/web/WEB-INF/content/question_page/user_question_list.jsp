            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <img src="../img/log1.jpg" class="img-responsive" alt="Responsive image"
                             style="width: 60px;height: 50px;"/>
                    </div>
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                        <ul class="nav navbar-nav">
                            <li><a href="${pageContext.request.contextPath}/jump/Jump2user_evaluate"><span
                                    class="glyphicon glyphicon-question-sign"></span>&nbsp;&nbsp;&nbsp;提问</a></li>
                        </ul>
                        <ul class="nav navbar-nav">
                            <li><a href="#"><span class="glyphicon glyphicon-edit"></span>&nbsp;&nbsp;&nbsp;写文章</a></li>
                        </ul>
                        <form class="navbar-form navbar-left"
                              action="${pageContext.request.contextPath}/questions/condition_search" method="post"
                              role="search" name="conditionSearch">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="输入要检索的问题">
                            </div>
                            <button type="submit" class="btn  btn-info">搜索问题</button>
                        </form>
                        <a href="${pageContext.request.contextPath}/questions/user_myquestionList">
                            <button type="button" class="btn  btn-info">搜索问题</button>
                        </a>
            ...
            <div>
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        ...
                        <span class="badge" style="background-color: #5bc0de; border-radius: 6x;"><a
                                href="${pageContext.request.contextPath}/questions/question_deleteOnequestion?id=<%=q.getQuestionId()%>"><button
                                type="button" class="btn  btn-info">删除</button></a></span>
