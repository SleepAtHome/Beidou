			      ...
			      <form action="${pageContext.request.contextPath}/user/user_login" method="post">
			       <div class="form-group  has-feedback">
					...
					<div class="form-group">
					    ...
					    <img src="${pageContext.request.contextPath}/kaptcha/Kaptcha.jpg" class="col-xs-3" style="width: 120px;height: 34px;consor:pointer;"onclick="this.src='${pageContext.request.contextPath}/kaptcha/Kaptcha.jpg?aa='+Math.random();"/>
					 ...
					 <button type="submit" class="btn btn-default btn-md">登录</button>
						 <a href="${pageContext.request.contextPath}/jump/Jump2user_regist" class="btn btn-default btn-md">注册</a>
		               </div>
		               </form>
			      </div>
